        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Refugees_Centers_CenterId",
                        column: x => x.CenterId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RefugeeNGOs", x => new { x.RefugeeId, x.NGOId });
                    table.ForeignKey(
                        name: "FK_RefugeeNGOs_NGOs_NGOId",
                        column: x => x.NGOId,
                        principalTable: "NGOs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RefugeeNGOs_Refugees_RefugeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RefugeesDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RefugeesDetails_Refugees_RefugeeId",
                        column: x => x.RefugeeId,
                        principalTable: "Refugees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefugeeNGOs_NGOId",
                table: "RefugeeNGOs",
                column: "NGOId");

            migrationBuilder.CreateIndex(
                name: "IX_Refugees_CenterId",
                table: "Refugees",
                column: "CenterId");

            migrationBuilder.CreateIndex(
                name: "IX_RefugeesDetails_RefugeeId",
                table: "RefugeesDetails",
                column: "RefugeeId",
                unique: true);
